...
(function (f) {
    ...
    // returns an iife
    return (function e(mods, reqs, arr60) {
        function init(o, u) {
            if (!reqs[o]) {
                if (!mods[o]) {
                    ...
                    if (!u && a)
                        return a(o, true);
                    if (hasReq)
                        return hasReq(o, true);
                    var f = new Error("Cannot find module '" + o + "'");
                    throw f.code = "MODULE_NOT_FOUND", f
                }
                var l = reqs[o] = { exports: {} };
                mods[o][0].call(l.exports, function (e) {
                    var n = mods[o][1][e];
                    return init(n ? n : e)
                }, l, l.exports, e, mods, reqs, arr60)
            }
            return reqs[o].exports
        }
        var hasReq = typeof require == "function" && require;
        for (var o = 0; o < arr60.length; o++)
            init(arr60[o]);
        return init
    })({ // param t starts here

using MarketMiner.Api.OANDA.REST20.TradeLibrary.DataTypes;
using MarketMiner.Api.OANDA.REST20.TradeLibrary.DataTypes.Communications;
using MarketMiner.Api.OANDA.REST20.TradeLibrary.DataTypes.Communications.Requests;
using System;
...
namespace MarketMiner.Api.OANDA.REST20
{
    ...
    {
        // Convenience helpers
        private static string Server(EServer server) { return Credentials20.GetDefaultCredentials().GetServer(server); }
        private static string AccessToken { get { return Credentials20.GetDefaultCredentials().AccessToken; } }
        ...
        public static async Task<List<AccountProperties>> GetAccountListAsync(string user = "")
        {
            string requestString = Server(EServer.Account) + "accounts";
        ...
        public static async Task<List<TradeData>> GetTradeListAsync(string account, Dictionary<string, string> requestParams = null)
        {
        ...
        public static async Task<List<Order>> GetOrderListAsync(string accountId, Dictionary<string, string> requestParams = null)
        {
        ...
        public static async Task<Order> GetOrderDetailsAsync (string accountId, long orderId) {
        ...
        public static async Task<TradeData> GetTradeDetailsAsync(string accountId, long tradeId)
        {
        ...
        /// <returns></returns>
        public static async Task<List<Transaction>> GetTransactionListAsync(string accountId, Dictionary<string, string> parameters = null)
        {
        ...
        public static async Task<Account> GetAccountDetailsAsync(string accountId)
        {
            ...
            var accountDetails = await MakeRequestAsync<AccountResponse>(requestString);
        ...
        public static async Task<DeletePositionResponse> DeletePositionAsync(string accountId, string instrument)
        {
            string requestString = Server(EServer.Account) + "accounts/" + accountId + "/positions/" + instrument;
        ...
        public static async Task<List<Instrument>> GetInstrumentsAsync(string account, List<string> fields = null, List<string> instrumentNames = null)
        {
        ...
        public static async Task<PostOrderResponse> PostOrderAsync(string account, Dictionary<string, string> requestParams)
        {
        ...
        public static async Task<Order> PatchOrderAsync(string accountId, long orderId, Dictionary<string, string> requestParams)
        {
            string requestString = Server(EServer.Account) + "accounts/" + accountId + "/orders/" + orderId;
        ...
        public static async Task<TradeData> PatchTradeAsync(string accountId, long tradeId, Dictionary<string, string> requestParams)
        {
            string requestString = Server(EServer.Account) + "accounts/" + accountId + "/trades/" + tradeId;
        ...
        public static async Task<Order> DeleteOrderAsync(string accountId, long orderId)
        {
            string requestString = Server(EServer.Account) + "accounts/" + accountId + "/orders/" + orderId;
        ...
        public static async Task<DeleteTradeResponse> DeleteTradeAsync(string accountId, long tradeId)
        {
            string requestString = Server(EServer.Account) + "accounts/" + accountId + "/trades/" + tradeId;
        ...
        public static async Task<WebResponse> StartRatesSession(List<Instrument> instruments, string accountId)
        {

...
namespace MarketMiner.UI
{
   ...
   /// </summary>
   public sealed partial class InputSplitPage : MarketMiner.UI.Common.LayoutAwarePage
   {
      public InputSplitPage()
      {
      ...
      protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
      {
         ...
         var group = MUIAccountDataSource.GetGroup((String)navigationParameter);
         ...
         else
         {
            ...
            {
               var selectedItem = MUIAccountDataSource.GetItem((String)pageState["SelectedItem"]);
